...
const getUserInfoStorage = () => {
  ...
  try{
    ...
    //TODO handle the exception
    console.log("getUserInfoStorage",userInfo)
  }
  return userInfo
}
...
http.interceptor.request((config, cancel) => { /* 请求之前拦截器 */
 ...
 debugger;
  var userInfo=getUserInfoStorage();//如果有sessionkey则进行扩展添加
  if(userInfo&&userInfo.SESSIONKEY){
    config.data={...config.data,SESSIONKEY:userInfo.SESSIONKEY,token:userInfo.token}
  }
  /*
